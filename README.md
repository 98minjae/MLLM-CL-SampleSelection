...
```
conda create -n sample_selection python=3.10
conda activate sample_selection
pip install transformers==4.49.0
pip install torch==2.2.1 torchvision xformers==0.0.25 --index-url https://download.pytorch.org/whl/cu118
pip install flash-attn==2.5.7 --no-build-isolation
pip install peft==0.11.1 trl==0.8.6 deepspeed==0.16.0 bitsandbytes pandas kornia opencv-python timm torch_optimizer easydict pycocoevalcap sentencepiece protobuf  loguru captum POT jsonlines imageio
pip install -U scikit-learn
pip install numpy==1.26.4 faiss-cpu h5py qpsolvers qpsolvers["osqp"] qwen_vl_utils
...
- `bash train_VLM_CL.sh`
    - Arguments:
        ...
        - MODE: Name of method (method in `selection_methods/method_manager.py`)
