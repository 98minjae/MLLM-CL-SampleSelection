...
json_data_list_train_digit = json_data_list[:ratio]
json_data_list_test_digit = json_data_list[ratio:]
...
# json_output_path = os.path.join(output_folder, 'train/dataset-99.json')
# with open(json_output_path, 'w') as json_file:
#     json.dump(json_data_list_train, json_file, indent=4)
    
# json_output_path = os.path.join(output_folder, 'test/dataset-99.json')
# with open(json_output_path, 'w') as json_file:
...
for idx, item in enumerate(digit_data):
    ...
    json_data_list.append(item)
ratio = int(len(json_data_list)*0.8)
json_data_list_train_choices = json_data_list[:ratio]
json_data_list_test_choices = json_data_list[ratio:]
