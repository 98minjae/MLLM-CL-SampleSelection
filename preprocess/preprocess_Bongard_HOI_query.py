...
def save_dataset(dataset_name, output_folder, subset_name, max_num=None):
    ...
    json_output_path = os.path.join(output_folder, subset_name, f'dataset-99.json')
...
save_dataset('Bongard-HOI', output_folder, 'test')
save_dataset('Bongard-HOI', output_folder, 'train')