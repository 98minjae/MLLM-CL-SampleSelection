...
def sft_org_create_trainer(model, tokenizer, training_args, data_module, extra_state_dict_dict, curr_ema=None, curr_ema_var=0,datalist_prob=None, ema_data_module=None, ema_pool=None,return_task_vectors=False, model_args=None):
...
class LLaVATrainerFEDAVG(LLaVATrainer):
    def __init__(self, model_args,ema_ratio, client_id, curr_round, task_vector=None, fisher_old=None, fisher_freq=5, return_embedding=None, return_task_vectors=False, selection_method=None, kmeans=None, select_ratio=None,eval_period=8000, curr_ema=None, curr_ema_var=0, **kwargs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if not self.return_task_vectors:
                    with self.accelerator.accumulate(model):
                        tr_loss_step, output = self.training_step(model, inputs, return_outputs=True)
